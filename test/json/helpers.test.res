...
//   switch result {
//   | Ok("1", state) if remaining(state) == "0" =>
//     t->pass(~message="Should be a digit with a char remaining", ())
//   | _ => t->fail()
//   }
...
//   switch result {
//   | Ok("1", state) if remaining(state) == "hello" =>
//     t->pass(~message="Should be a digit with a char remaining", ())
//   | _ => t->fail()
//   }
// })
...
//   | Ok(_, rest) => t->fail(~message=`Passed with "${remaining(rest)}" remaining`, ())
//   | Error(_) => t->fail()
//   }
...
//   switch result {
//   | Ok("123", state) if remaining(state) == "" => t->pass()
//   | Ok(_, rest) => t->fail(~message=`Passed with "${remaining(rest)}" remaining`, ())
//   | Error(_) => t->fail()
//   }
...
//   switch result {
//   | Ok("123", state) if remaining(state) == "asdf" => t->pass()
//   | Ok(_, rest) => t->fail(~message=`Passed with "${remaining(rest)}" remaining`, ())
//   | Error(_) => t->fail()
//   }
// })
