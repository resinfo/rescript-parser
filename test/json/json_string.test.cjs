...
Ava.test("[JSON] String succeeds", (function (t) {
        var msg = Parser.run(Json.parse, "\"1\"");
        if (msg.TAG === /* Ok */0) {
          var match = msg._0;
          var match$1 = match[0];
        ...
        var msg$1 = Parser.run(Json.parse, "\"hello\"");
        if (msg$1.TAG === /* Ok */0) {
        ...
        var msg$2 = Parser.run(Json.parse, "\"   \"");
        if (msg$2.TAG === /* Ok */0) {
        ...
        var msg$3 = Parser.run(Json.parse, "\"\"");
        if (msg$3.TAG === /* Ok */0) {
        ...
        var msg$4 = Parser.run(Json.parse, "\"\u0050\"");
        if (msg$4.TAG === /* Ok */0) {
        ...
        var msg$5 = Parser.run(Json.parse, "\"\u0050\u0069\u0061n\u006F\"");
        if (msg$5.TAG !== /* Ok */0) {
